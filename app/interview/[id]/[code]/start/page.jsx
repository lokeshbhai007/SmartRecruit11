// app/interview/[id]/[code]/start/page.jsx
...
export default function InterviewStartPage() {
  ...
  const toggleMic = () => {
    ...
    // Here you would also implement the actual microphone muting logic
    if (!isMicEnabled) {
      setListening(true); // Resume listening if mic is enabled
    } else {
      setListening(false); // Stop listening if mic is disabled
    }
  };
    ...
    <div className="min-h-screen bg-slate-900 flex flex-col">
      <div className="flex-1 max-w-5xl mx-auto w-full p-4">
        ...
        <div className="flex gap-4 mb-6">
          {/* Mic Button */}
          <MicButton isMicEnabled={isMicEnabled} toggleMic={toggleMic} />
